...
int exitPoolDestroy(apr_pool_t *p_parent_pool, int c_val);
...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(argv[1], "--enc") == 0) {
        ...
        if (argc != ARG_COUNT) {
            ...
            return exitPoolDestroy(p_parent_pool, EXIT_FAILURE);
        }
    ...
    return exitPoolDestroy(p_parent_pool, EXIT_SUCCESS);
}
